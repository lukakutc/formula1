const arrayEquipos = [
    ...
    },
    {
        ...
        logo: "assets/img/equipos/aston-martin/logo/logo-aston-martin.png",
    ...
    arrayEquipos.forEach(equipo => {
        ...
        li.innerHTML = `
            <div class="card-equipo" style="--team-color: ${equipo.colorCard}">
                ...
                <img src="assets/img/equipos/redbullracing/auto/2025redbullracingcarright.webp" alt="auto Red Bull"
                    class="auto-equipo">
            </div>
        `;
