...
async function cargarDatosEquipos() {
    try {
        ...
        if (listaEquipos) {
            listaEquipos.innerHTML = '<p>Error al cargar los equipos. Intenta recargar la página.</p>';
        }
    }
}
...
function cargarPerfil() {
    ...
    if (equipo && fondo) {
        ...
        // También puedes cargar los pilotos aquí si los necesitas
...
function cargarPilotos(equipo) {
    // Aquí puedes agregar la lógica para mostrar los pilotos
    const equipoPilotos = document.getElementById("equipo-pilotos");
    console.log(equipoPilotos);

    // Ejemplo de cómo podrías mostrar los pilotos:
